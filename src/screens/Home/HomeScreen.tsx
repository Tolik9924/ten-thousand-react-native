...
export default function HomeScreen({ navigation }: any) {
  ...
  return (
    <View style={{ flex: 1, padding: 20 }}>
      ...
      <Text style={{ fontSize: 18, marginVertical: 10 }}>Personal Advisor</Text>
      <View style={{ height: 50, backgroundColor: "#eee", marginBottom: 20 }} />

      <Text style={{ fontSize: 18, marginVertical: 10 }}>Before you Start</Text>
      <View style={{ height: 50, backgroundColor: "#eee", marginBottom: 20 }} />
